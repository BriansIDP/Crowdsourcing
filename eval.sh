...
trainfile=data/Arena/arena_hard_binary_bt_short_subset.json
# trainfile=data/MMLU_judge/mmlu_binary_short.json
expdir=exp/pewcrowd_gpt2_mse_direct_crowdlayer_${mode}_${regression}_${task}_BT
